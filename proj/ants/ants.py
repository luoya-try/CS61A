...
class Ant(Insect):
    ...
    def add_to(self, place):
        if place.ant is None:
            ...
            if isinstance(place.ant, ContainerAnt) == True and place.ant.can_contain(self):
                place.ant.contain_ant(self)
            elif isinstance(self, ContainerAnt) == True and self.can_contain(place.ant):
...
class ThrowerAnt(Ant):
    ...
    def nearest_bee(self, beehive):
        ...
        while cur is not beehive:
            if self.min_range <= i <= self.max_range and len(cur.bees):
                return rANTdom_else_none(cur.bees)
            cur, i = cur.entrance, i + 1
        return None
...
class FireAnt(Ant):
    ...
    def reduce_armor(self, amount):
        ...
        # BEGIN Problem 5
        "*** YOUR CODE HERE ***"
        sub = amount + (amount >= self.armor) * self.damage      
        cpy = list(self.place.bees)
        for i in cpy:
            Insect.reduce_armor(i, sub)
...
# END Problem EC
    ...
    def __init__(self, armor=1):
        ...
        if QueenAnt.first == False:
            self.is_first, QueenAnt.first = True, True
        # END Problem EC
    ...
    def action(self, gamestate):
        ...
        if self.is_first == False:
            ...
            while cur_place:
                if cur_place.ant:
                    ant = cur_place.ant
                    if ant.is_double == False:
                        ant.damage, ant.is_double = ant.damage * 2, True
    ...
    def reduce_armor(self, amount):
        ...
        if self.is_first == True and self.armor == 0:
            bees_win()
        # END Problem EC
...
class Bee(Insect):
    ...
    def blocked(self):
        ...
        # print(type(self.place.ant), type(self.place.ant).blocks_path)
    ...
    def action(self, gamestate):
        ...
        elif self.armor > 0 and destination is not None and destination is not Hive:
...
class ContainerAnt(Ant):
    ...
    def can_contain(self, other):
        # BEGIN Problem Optional 2
        return self.contained_ant == None and isinstance(other, ContainerAnt) == False
        # END Problem Optional 2
